...
$('#asielbundle_statustype_adopted_search').keyup(function() {
    // Get the typed value
...
$("body")
    .on("click", "#resulttable .customer", function() {
        ...
        $("#asielbundle_statustype_adopted_customer").attr("value", customId);
        ...
        $('#asielbundle_statustype_adopted_search').val(firstname+' '+lastname);
        $('#resulttable').hide();
    })
    .click(function () {
        $('#resulttable').hide();
